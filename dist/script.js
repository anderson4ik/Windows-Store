...
window.addEventListener("DOMContentLoaded", function () {
  ...
  var modalState = {};
  var deadline = '2020-12-31T00:00:00.000+02:00';
  ...
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])(".decoration_slider", ".no_click", ".decoration_content > div > div", "after_click"); // '.decoration_content > div > div' - Matches any div element that is a child of class '.decoration_content'.
  ...
  function bindActionToElems(event, elem, prop) {
    elem.forEach(function (item, index) {
      item.addEventListener(event, function () {
        switch (item.nodeName // to check name of node
        ) {
          case "SPAN":
            state[prop] = index;
            break;
...
var checkNumInputs = function checkNumInputs(selector) {
  ...
  numInputs.forEach(function (item) {
    item.addEventListener('input', function () {
      item.value = item.value.replace(/\D/, ''); // remove all symbols that isn't numbers
    });
  });
};
...
var closeModalWindows = function closeModalWindows() {
  var windows = document.querySelectorAll("[data-modal]"); // data attr
...
var forms = function forms(state) {
  ...
  form.forEach(function (item) {
    item.addEventListener("submit", function (e) {
      e.preventDefault();
      var statusMessage = document.createElement("div"); // creating element

      statusMessage.classList.add("status"); // adding class

      item.appendChild(statusMessage); // sending to DOM

      var formData = new FormData(item); // The FormData object lets you compile a set of key/value pairs to send using XMLHttpRequest.
      ...
      postData("assets/server.php", formData).then(function (res) {
        ...
        setTimeout(function () {
          ...
          Object(_closeModalWindows__WEBPACK_IMPORTED_MODULE_6__["default"])(); // closing also all modal window that is opened
...
var images = function images() {
  ...
  workSection.addEventListener('click', function (e) {
    ...
    if (target && target.classList.contains("preview")) {
      ...
      var path = target.parentNode.getAttribute('href'); // getting path to big img from parent element <a>
...
var modals = function modals() {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(function (item) {
      ...
      item.addEventListener("click", function (event) {
        ...
        document.body.style.marginRight = "".concat(scroll, "px"); // to prevent jumping of page right when scroll disapper
      });
    });
  ...
  function calcScroll() {
    ...
    var scrollWidth = div.offsetWidth - div.clientWidth; // return scroll-bar width
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  ...
  var header = document.querySelector(headerSelector),
      ...
      content = document.querySelectorAll(contentSelector); //active = document.querySelectorAll(activeClass);
  ...
  header.addEventListener("click", function (e) {
    var target = e.target; // check if we click on tab or tab child by class

    if (target && ( // check if target exist, because some elements not support event click
    target.classList.contains(tabSelector.replace(/\./, "")) || // removing dot(.) from tabSelector using regular expretion
...
var timer = function timer(id, deadline) {
  ...
  var getTimeRemaining = function getTimeRemaining(endtime) {
    ...
    seconds = Math.floor(t / 1000 % 60),
        // return remain after dividing by 60s in one minutes
    minutes = Math.floor(t / 1000 / 60 % 60),
        // return remain of minutes after dividing by 60min in one hour
    hours = Math.floor(t / 1000 / 60 / 60 % 24),
        // return remain of hours after dividing by 24hours in one day
